...
void container_arrange_title_bar(struct sway_container *con) {
	...
	wlr_scene_rect_set_size(con->title_bar.background, back_width, back_height);
	...
	if (vertical) {
		wlr_scene_rect_set_size(con->title_bar.border, height, width);
	} else {
